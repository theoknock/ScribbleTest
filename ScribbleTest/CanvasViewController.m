...
- (void)viewDidLoad {
    ...
    _textRequest = [[VNRecognizeTextRequest alloc] initWithCompletionHandler:^ (UILabel * topCandidatesLabel, UIImageView * numberImageView) {
    ...
    }(self.topCandidatesLabel, self.numberImageView)];
